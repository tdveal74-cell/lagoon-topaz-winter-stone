...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-o7n2vDJK.mjs");
...
var manifest = {
	"40f5c6cc73e39f5ea5beee14e7f03cc34a7e12bd30187f49fc705f9c895e8bba": {
		functionName: "dispatchAgent_createServerFn_handler",
		importer: () => import("./ai-vMX1BImR.mjs")
	},
	"66de95bfb06f0583d278bbdd20ffc8a599bb95b00606f1f36e4258c815a2def5": {
		functionName: "generateMotion_createServerFn_handler",
		importer: () => import("./ai-vMX1BImR.mjs")
	},
	...
	"b41f3cbecc7f8f47bb45dd6c1228638efcb3f9ce489ae6add2397b6dabce8902": {
		functionName: "planCanvas_createServerFn_handler",
		importer: () => import("./ai-vMX1BImR.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C2iD6btd.mjs").then((n) => n.t),
